...
async def demo_policy_enforcement():
    ...
    policy_layer.check_action(test1)
    print_info("Test 1 - Read user file: [green]ALLOWED[/green]")
    ...
    if result3["requires_confirmation"]:
        print_info("Test 3 - Production deploy: [yellow]REQUIRES CONFIRMATION[/yellow]")
