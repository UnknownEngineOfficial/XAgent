...
class TestAgentPlannerIntegration:
    ...
    async def test_create_goal_with_legacy_planner(self):
        ...
        goal = agent.goal_engine.create_goal(
            description="Test goal with legacy planner", mode=GoalMode.GOAL_ORIENTED, priority=5
        )
    ...
    async def test_create_goal_with_langgraph_planner(self):
        ...
        # Create a goal
        goal = agent.goal_engine.create_goal(
            description="Test goal with LangGraph planner", mode=GoalMode.GOAL_ORIENTED, priority=5
        )
    ...
    async def test_legacy_planner_returns_plan(self):
        ...
        goal = agent.goal_engine.create_goal(
            description="Write a Python function", mode=GoalMode.GOAL_ORIENTED, priority=5
        )
