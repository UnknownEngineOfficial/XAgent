...
def test_websocket_unknown_message_type(client):
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        message = {"type": "unknown_type", "content": "test"}
...
def test_websocket_command_message(client):
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        # Send command
        message = {"type": "command", "content": "Test command"}
        websocket.send_json(message)
...
def test_websocket_feedback_message(client):
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        # Send feedback
        message = {"type": "feedback", "content": "Test feedback"}
        websocket.send_json(message)
...
def test_websocket_start_message(client):
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        # Send start message
        message = {"type": "start", "goal": "Test goal"}
        websocket.send_json(message)
