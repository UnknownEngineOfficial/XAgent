...
class OPAClient:
    ...
    async def check_api_access(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "deny_reasons": deny_reasons if isinstance(deny_reasons, list) else [deny_reasons] if deny_reasons else [],
        }
...
def get_opa_client(settings: Optional[Settings] = None) -> OPAClient:
    """
